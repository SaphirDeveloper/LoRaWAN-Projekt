...
namespace LoRaWAN.SemtechProtocol
{
    public static class SemtechPacketFactory
    {
        ...
        // Create
        public static PullResp CreatePullResp(string token, string hexData, float freq, string datr, string codr)
        {
            Txpk txpk = new Txpk();
            txpk.Imme = true;
            txpk.Rfch = 0;
            ...
            txpk.Data = Convert.ToBase64String(temp);
            txpk.Size = temp.Length;
