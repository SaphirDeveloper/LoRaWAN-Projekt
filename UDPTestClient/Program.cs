...
byte[] dataUpFPort5 = Utils.HexStringToByteArray("");
byte[] dataUpFPort3 = Utils.HexStringToByteArray("");
...
try
{
    ...
    Console.WriteLine($"Data Up (FPort 3) JSON: {Encoding.UTF8.GetString(dataUpFPort3[12..])}");
    Console.WriteLine($"Data Up (FPort 5) JSON: {Encoding.UTF8.GetString(dataUpFPort3[12..])}");
    Console.WriteLine();
    ...
    // Data uplink (FPort 3)
    Thread.Sleep(200);
    udpClient.Send(dataUpFPort3);
    result = udpClient.Receive(ref end);
    Console.WriteLine($"Push Ack : {BitConverter.ToString(result)}");

    // Data uplink (FPort 5)
    Thread.Sleep(200);
    udpClient.Send(dataUpFPort5);
    result = udpClient.Receive(ref end);
    Console.WriteLine($"Push Ack : {BitConverter.ToString(result)}");
